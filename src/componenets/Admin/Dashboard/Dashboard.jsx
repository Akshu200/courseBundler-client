  ...
  return (
    ...
    >
      <Box boxSizing="border-box" py="16" px={['4', '0']}>
        ...
        >
          <Databox title="Views" qty={122} qtyPercentage={50} profit={true} />
          <Databox title="User" qty={10} qtyPercentage={5} profit={false} />
          <Databox
            title="Subscription"
            qty={1220}
            qtyPercentage={500}
        ...
        <Grid templateColumns={['1fr', '2fr 1fr']}>
          <Box p="4">
            ...
            <Box>
              <Bar profit={true} title="Views" value={25} />
              <Bar profit={true} title="Users" value={14} />
              <Bar profit={true} title="Subscription" value={75} />
            </Box>
          </Box>
